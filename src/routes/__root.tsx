...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ConectaChat — Atendente de WhatsApp com IA + CRM Kanban" },
      { name: "description", content: "Conecte seu número de WhatsApp em 2 minutos. A IA da ConectaChat responde, qualifica e move cada lead no funil automaticamente. 14 dias grátis para testar." },
      { name: "author", content: "AtendeZap" },
      { property: "og:title", content: "ConectaChat — Atendente de WhatsApp com IA + CRM Kanban" },
      { property: "og:description", content: "Conecte seu número de WhatsApp em 2 minutos. A IA da ConectaChat responde, qualifica e move cada lead no funil automaticamente. 14 dias grátis para testar." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "ConectaChat — Atendente de WhatsApp com IA + CRM Kanban" },
      { name: "twitter:description", content: "Conecte seu número de WhatsApp em 2 minutos. A IA da ConectaChat responde, qualifica e move cada lead no funil automaticamente. 14 dias grátis para testar." },
